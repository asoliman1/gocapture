export const Countries: {value: string, name: string, aliases?: string[]}[] = [
  {value:"United States", name:"United States", aliases: ['US', 'USA']},
  ...
  {value:"France", name:"France", aliases: ['FR', 'FRA']},
  ...
  {value:"Spain", name:"Spain", aliases: ['ESP', 'ES']},
