...
@property (nonatomic)         BOOL                        isRapidScanMode;
@property (nonatomic)         NSInteger                   rapidScanModeDelay;
@property (nonatomic, retain) NSMutableArray*             barcodes;
...
- (void)scan:(CDVInvokedUrlCommand*)command {
    ...
    BOOL isRapidScanMode = [options[@"isRapidScanMode"] boolValue];
    NSInteger rapidScanModeDelay = [options[@"rapidScanModeDelay"] integerValue];
    ...
    processor.isRapidScanMode = isRapidScanMode;

    processor.rapidScanModeDelay = rapidScanModeDelay;
...
- (void)returnBarcodes:(NSArray *)barcodes callback:(NSString*)callback {
    NSMutableDictionary* resultDict = [NSMutableDictionary new];
