...
+ (instancetype) createFromTakePictureArguments:(CDVInvokedUrlCommand*)command
{
    ...
    pictureOptions.shouldDisplayOverlay = [[command argumentAtIndex:12 withDefault:@(NO)] boolValue];

    NSNumber* previewBoxPositionX = [command argumentAtIndex:13 withDefault:nil];
